...
- Oracle JDBC Thin driver is downloaded and configured.  Specific instructions on installing the jar file to dataiku are [here](https://github.com/oracle-samples/adb-connectors/blob/main/common/jdbc/jdbc-thin.md).
